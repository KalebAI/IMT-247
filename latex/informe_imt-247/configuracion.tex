...
%=====================================================================
% Paquetes bibliografía
%=====================================================================
\usepackage{cite}			  	% para compresión de citas IEEE
\makeatletter
\renewenvironment{thebibliography}[1]
{\section*{}% quitamos el título automático
...
\newcommand{\caratula}{
	\begin{titlepage}
		\begin{center}
			...
			{\fontsize{14}{16}\selectfont ESTUDIANTES: \MakeUppercase{\Autor}\\
				DOCENTE: \MakeUppercase{\Docente}}
		\end{center}
		\vspace{0.2cm}
		{\begin{center}
